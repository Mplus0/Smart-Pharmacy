    ...
    def __init__(self):
        ...
        while(not rospy.is_shutdown()):#如果ros系统没有关机的话
            ...
            if(self.count == 9):#从起点到识别区
                ...
                # temp ='/home/EPRobot/robot_ws/src/pharmacy_pkg/yuyingwenjian/'
                # A="/yuyingwenjian/qdA.wav"
                # B="/yuyingwenjian/qdB.wav"
                # C="/yuyingwenjian/qdC.wav"
                # CA="/yuyingwenjian/qdAC.wav"#新文件名字
                # BC="/yuyingwenjian/qdBC.wav"#新文件名字
                # CAB="/yuyingwenjian/qdABC.wav"#新文件名字
                # AB="/yuyingwenjian/qdAB.wav"#新文件名字
                # B1 = '/yuyingwenjian/jingmaixue.wav'
                # B2 = '/yuyingwenjian/tuoye.wav'
                # B3 = '/yuyingwenjian/zuzhi.wav'
                # B4 = '/yuyingwenjian/xuejiang.wav'
                ...
                #播报样本类型
                #rospy.sleep(1)#可以试试能不能去掉
                # if(self.windows_1234 == 3): #4(激素检验窗口)
                #     rospy.loginfo("血浆样本") #后面加播报
                #     os.system("play "+temp+B4)
                # if(self.windows_1234 == 2): #3(免疫检测窗口)
                #     rospy.loginfo("组织样本") #后面加播报
                #     os.system("play "+temp+B3)
                # if(self.windows_1234 == 1): #2(体液窗口)
                #     rospy.loginfo("唾液样本") #后面加播报
                #     os.system("play "+temp+B2)
                # if(self.windows_1234 == 0): #1(血常规窗口)
                #     rospy.loginfo("静脉血样本") #后面加播报
                #     os.system("play "+temp+B1)
                ...
                if(self.move(goal) == True):
                    ...
                    #播报样本数量
                    #rospy.sleep(1) #看看能不能去掉
                    # if self.windows_count == 3:
                    #         rospy.loginfo("样本数为3")
                    #         os.system("play "+temp+C3)
                    # elif self.windows_count == 2:
                    #         rospy.loginfo("样本数为2")
                    #         os.system("play "+temp+C2)
                    # elif self.windows_count == 1:
                    #         rospy.loginfo("样本数为1")
                    #         os.system("play "+temp+C1)
