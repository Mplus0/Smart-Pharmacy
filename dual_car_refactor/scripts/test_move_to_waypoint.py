...
Standalone waypoint test node for pharmacy_pkg.

Usage examples:
  rosrun pharmacy_pkg test_move_to_waypoint.py _target:=A
  rosrun pharmacy_pkg test_move_to_waypoint.py _target:=board1
  rosrun pharmacy_pkg test_move_to_waypoint.py _target:=lab3
  rosrun pharmacy_pkg test_move_to_waypoint.py _target:=home
